...
<div <?php echo get_block_wrapper_attributes([ 'class' => 'tnc-block tnc-profile-cards-item tnc-block-content' ]); ?>>
	<?php
		...
		if ( isset( $attributes['buttonLabel'] ) && $attributes['buttonLabel'] && isset( $attributes['buttonUrl'] ) && $attributes['buttonUrl'] ) :
			...
			<div class="wp-block-button mt-4">
				<a href="<?php echo esc_url( $attributes['buttonUrl'] ); ?>" class="wp-block-button__link wp-element-button inline-flex"><?php echo esc_html( $attributes['buttonLabel'] ); ?></a>
			</div>
			<?php
		endif;
	?>
